...
from models.SC_GPT.utils.loader.DataReader import *
from models.SC_GPT.utils.loader.GentScorer import *
...
def score(domain,target_file):
    ...
    train       = f'.data/RNNLG/{domain}/train.json'
    valid       = f'.data/RNNLG/{domain}/train.json'
    test        = f'.data/RNNLG/{domain}/test.json'
    # test        = f'../../.data/RNNLG/original/{domain}/test.json'
    vocab       = 'models/SC_GPT/utils/resource/vocab'
    percentage  = 100
    topk        = 5
    detectpairs = 'models/SC_GPT/utils/resource/detect.pair'
    ...
    results_from_gpt = target_file# json.load(open(target_file))
    idx = 0
    ...
    while True:
        ...
        # print(a,sv,s,v,sents,dact,bases,cutoff_b, cutoff_f )
