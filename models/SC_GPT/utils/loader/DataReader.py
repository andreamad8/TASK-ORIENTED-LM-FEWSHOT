...
from models.SC_GPT.utils.nlp.nlp import *
...
class DataReader(object):
    ...
    def _setCardinality(self):
        ...
        self.cardinality = []
        fin = file('models/SC_GPT/utils/resource/feat_template.txt')
        self.dfs = [0,0,0,0,0]
    ...
    def _loadTokenMap(self,mapfile='models/SC_GPT/utils/resource/detect.pair'):
        fin  = file(mapfile)
